...
//public class PostResultService : BaseService<IRepositoryManager, PostDbContext>, IPostResultService
//{
//    public PostResultService(IRepositoryManager repoManager, IMapper mapper, IValidatorFactory validatorFactory, IUnitOfWork<PostDbContext> unitOfWork) : base(repoManager, mapper, validatorFactory, unitOfWork)
//    {
